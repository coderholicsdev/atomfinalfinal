...
<head>
    ...
    <title>Small Small :: @yield('title')</title>
    <!-- Favicon icon -->
...
<body>
    ...
    ***********************************-->
    <div id="main-wrapper">
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="{{url('/home')}}" class="brand-logo">
                {{-- <img class="logo-abbr" src="{{ asset('assets/images/logo-rss.png')}}" alt=""> --}}
                <img class="logo-compact" src="{{ asset('assets/images/logo-rss.png')}}" alt="">
                <img class="brand-title" src="{{ asset('assets/images/logo-rss.png')}}" alt="">
            </a>
											...
											<li>
												<div class="timeline-panel">
													...
													<div class="media-body">
														<h6 class="mb-1">3 Dr sultads Send you Photo</h6>
            ...
            <div class="deznav-scroll">
				<ul class="metismenu" id="menu">
					...
					<li>
						...
						<ul aria-expanded="false">
							{{-- <li><a href="{{url('/add-landlord')}}">Add Landlord</a></li> --}}
							<li><a href="{{url('/all-landlord')}}">All Landlords</a></li>
						</ul>
					</li>
					<li>
						<a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
						...
						<ul aria-expanded="false">
							{{-- <li><a href="{{url('/add-tenant')}}">Add Tenant</a></li> --}}
							<li><a href="{{url('/all-users')}}">All Users</a></li>
							{{-- <li><a href="{{url('/converted-tenants')}}">Converted Tenants</a></li> --}}
						</ul>
					</li>
					...
					<li>
						...
						<ul aria-expanded="false">
							{{-- <li><a href="{{url('/add-tenant')}}">Add Tenant</a></li> --}}
							<li><a href="{{url('/all-tenants')}}">All Tenants</a></li>
							{{-- <li><a href="{{url('/converted-tenants')}}">Converted Tenants</a></li> --}}
						</ul>
					</li>
					...
					<li>
						...
						<ul aria-expanded="false">
							...
							<li><a href="{{url('/all-properties')}}">All Properties</a></li>
						</ul>
					</li>
					...
					<li>
						...
						<ul aria-expanded="false">
							{{-- <li><a href="{{url('/add-payout')}}">Add Payout</a></li> --}}
							<li><a href="{{url('/all-payouts')}}">All Payouts</a></li>
						</ul>
					</li>
					<li>
						<a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
						...
						<ul aria-expanded="false">
							<li><a href="{{url('/all-inspections')}}">All Inspections</a></li>
						</ul>
					</li>
					<li>
						<a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
						...
						<ul aria-expanded="false">
							<li><a href="{{url('/all-verifications')}}">All Verifications</a></li>
						</ul>
					</li>
					<li>
						<a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
						...
						<ul aria-expanded="false">
							<li><a href="{{url('/report-repair')}}">Report Repair</a></li>
						</ul>
					</li>
                    {{-- <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
				...
				<div class="copyright">
					<p><strong>Small Small PMD</strong> © 2022 All Rights Reserved</p>
        ...
        ***********************************-->
        <div class="footer">
            <div class="copyright">
                <p>Copyright © Small Small PMD 2022</p>
            </div>
        </div>
        <!--**********************************
            Footer end
    ...
    ***********************************-->
    ...
    <script src="{{ asset('assets/js/dashboard/workout-statistic.js')}}"></script>
