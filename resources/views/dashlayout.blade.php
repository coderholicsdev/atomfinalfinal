...
<!-- Mirrored from designreset.com/cork/ltr/demo11/index2.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 27 Mar 2022 12:15:12 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <link href="{{asset('assets/admin/assets/plugins/apex/apexcharts.css')}}" rel="stylesheet" type="text/css">
...
<div class="header-container">
    <header class="header navbar navbar-expand-sm">
        ...
        <div class="nav-logo align-self-center">
            <a class="navbar-brand" href="/home"><img alt="logo" src="{{asset('assets/img/AtomloansLogo.png')}}"> <span class="navbar-brand-name">ATOMLOANS</span></a>
        </div>
                ...
                <nav id="topbar">
                    <ul class="navbar-nav theme-brand flex-row  text-center">
                        <li class="nav-item theme-logo">
                            <a href="/home">
                                <img src="{{asset('assets/img/AtomloansLogo.png')}}" class="navbar-logo" alt="logo">
                            </a>
                        </li>
                        <li class="nav-item theme-text">
                            <a href="/home" class="nav-link"> ATOM LOANS </a>
                        </li>
                    </ul>
                    ...
                    <ul class="list-unstyled menu-categories" id="topAccordion">
                        ...
                        <li class="menu single-menu active">
                            <a href="/apply-loan"  class="dropdown-toggle">
                                <div class="">
        ...
        <ul class="navbar-item flex-row nav-dropdowns">
            <li class="nav-item dropdown language-dropdown more-dropdown">
                <div class="dropdown custom-dropdown-icon">
                    <a class="dropdown-toggle btn" href="#" role="button" id="customDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="{{asset('assets/admin/assets/img/ca.png')}}" class="flag-width" alt="flag">
                    </a>
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="customDropdown">
                        ...
                        <a class="dropdown-item" data-img-value="de" data-value="de" href="javascript:void(0);"><img src="{{asset('assets/admin/assets/img/de.png')}}" class="flag-width" alt="flag"> German</a>
                        <a class="dropdown-item" data-img-value="jp" data-value="jp" href="javascript:void(0);"><img src="{{asset('assets/admin/assets/img/jp.png')}}" class="flag-width" alt="flag"> Japanese</a>
                        <a class="dropdown-item" data-img-value="fr" data-value="fr" href="javascript:void(0);"><img src="{{asset('assets/admin/assets/img/fr.png')}}" class="flag-width" alt="flag"> French</a>
                        <a class="dropdown-item" data-img-value="ca" data-value="en" href="javascript:void(0);"><img src="{{asset('assets/admin/assets/img/ca.png')}}" class="flag-width" alt="flag"> English</a>
                    </div>
                </div>
            </li>
                                ...
                                <div class="media">
                                    <div class="user-img">
                                        <div class="avatar avatar-xl">
                                            {{--                                                <img src="{{asset('assets/admin/assets/img/profile-15.jpg')}}" alt="admin-profile">--}}
                                        </div>
                                    </div>
                                ...
                                <div class="media">
                                    <div class="user-img">
                                        <div class="avatar avatar-xl">
                                            ...
                                            {{--                                                <img src="{{asset('assets/admin/assets/img/profile-3.jpg')}}" alt="admin-profile">--}}
                                        </div>
                                    </div>
                                    <div class="media-body">
                                        <div class="">
            ...
            <li class="nav-item dropdown user-profile-dropdown order-lg-0 order-1">
                <a href="javascript:void(0);" class="nav-link dropdown-toggle user" id="user-profile-dropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <div class="media">
                        {{--                            <img src="{{ asset('assets/admin/assets/img/profile-7.jpg') }}" class="img-fluid" alt="admin-profile">--}}
                    </div>
                </a>
...
<!-- Mirrored from designreset.com/cork/ltr/demo11/index2.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 27 Mar 2022 12:15:15 GMT -->
</html>
